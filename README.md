...
3. Архитектуру, позволяющую легко добавлять новые сущности и механики взаимодействия (расширяемая)
    - Представьте, что после вас придут 10 джуниор-разработчиков, которые будут одновременно добавлять новые фичи.
    - Прочитайте readme.md директорий Core и Feature, они помогут еще лучше понять цели задачи.
